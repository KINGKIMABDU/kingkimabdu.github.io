...
/* the constellation that rises out of the bottom of the switch at night */
const STARS =
...
/* The theme lives outside React — in localStorage, in the OS preference and
   on <html data-theme> — so it is read as an external store rather than
...
export default function ThemeToggle() {
  ...
  const toggle = useCallback(() => {
    ...
    // let the palette crossfade, then drop the rule again so it stops
    // interfering with hover and entrance transitions
